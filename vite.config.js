...
export default {
    ...
    // According to https://vitejs.dev/sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssguide/static-deploy.html 
    base: '/gis_web_g9/', 
